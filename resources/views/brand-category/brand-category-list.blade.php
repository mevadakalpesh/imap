...
<div class="row page-titles mx-0">
  <div class="col-sm-6 p-md-0">
    <div class="welcome-text">
      ...
      <a class="btn btn-info" href="{{  route('brand-category.create') }}">Add brand-category</a>
...
<script type="text/javascript">
  $(function () {
    ...
    var dataTable = $('#serviceTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('brand-category.index') }}",
        columns: [
    ...
    $(document).on('click','.delete-service',function(){
      if(confirm('are you sure delete this brand category?')){
          var deleteUrl = '{{ route("brand-category.destroy","%service%") }}' ;
